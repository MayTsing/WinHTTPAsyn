...
type
  ...
  public
    ...
    destructor Destroy; override;
    function BuildContext(const AURL, AMethod: string): THttpContext; virtual;
  end;
  ...
  public
    ...
    destructor Destroy; override;
    function BuildContext(const AURL: string; const AMethod: string): THttpContext; override;
  end;
...
function THttpConnection.BuildContext(const AURL, AMethod: string):THttpContext;
begin
  Result := nil;
end;
...
function TWinHttpConnection.BuildContext(const AURL,
